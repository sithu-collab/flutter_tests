...
class TopPlantPage extends StatefulWidget {
  @override
  _TopPlantPageState createState() => _TopPlantPageState();
}

class _TopPlantPageState extends State<TopPlantPage> {
  @override
      ...
      body: ListView(
        children: <Widget>[
          Container(
            ...
            child: Column(
              children: <Widget>[
                _buildPlantCard('images/plant_6.jpg', 'Top', 'Mutual', '\$35.0'),

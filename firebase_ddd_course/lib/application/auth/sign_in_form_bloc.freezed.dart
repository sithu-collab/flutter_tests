...
// ignore: unused_element
  PasswordChanged passwordChanged(String passStr) {
...
mixin _$SignInFormEvent {
  ...
  Result when<Result extends Object>({
    @required Result emailAddressChanged(String emailStr),
  ...
  Result maybeWhen<Result extends Object>({
    Result emailAddressChanged(String emailStr),
...
class _$EmailaddressChanged implements EmailaddressChanged {
  const _$EmailaddressChanged(this.emailStr) : assert(emailStr != null);
  ...
  @override
  String toString() {
    return 'SignInFormEvent.emailAddressChanged(emailStr: $emailStr)';
  }
...
class _$PasswordChanged implements PasswordChanged {
  const _$PasswordChanged(this.passStr) : assert(passStr != null);
...
abstract class PasswordChanged implements SignInFormEvent {
  const factory PasswordChanged(String passStr) = _$PasswordChanged;
